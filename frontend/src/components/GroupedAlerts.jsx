    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          maxLength={300}
          className="w-full pl-4 pr-10 py-2 rounded-md bg-[#21262d] border border-gray-700 text-white text-sm placeholder-gray-500 focus:border-gray-500 focus:outline-none transition-colors"
        />
        {!searchTerm && (
