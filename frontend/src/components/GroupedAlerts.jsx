            ...
            {showFilterDropdown && (
              <>
                ...
                <div className="absolute right-0 top-full mt-1 z-20 bg-white border border-[#e2e6ea] rounded py-1 flex flex-col min-w-[100px] sm:min-w-[120px]">
                  ...
                  >
                    <span className={`w-3 h-3 sm:w-3.5 sm:h-3.5 rounded border ${filterActive ? 'bg-[#0f2942] border-[#0f2942]' : 'border-[#d0d7de]'}`} />
                    Active
                  </button>
                  <button
                    onClick={(e) => {
                    ...
                    className="flex items-center gap-2 text-left px-2.5 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm hover:bg-[#eef1f4] transition text-[#57606a]"
                  >
                    <span className={`w-3 h-3 sm:w-3.5 sm:h-3.5 rounded border ${filterCompleted ? 'bg-[#0f2942] border-[#0f2942]' : 'border-[#d0d7de]'}`} />
                    Completed
                  </button>
                </div>
              </>
                      ...
                      <React.Fragment key={key}>
                        ...
                        >
                          ...
                          <td className="w-12 px-1 sm:px-2 py-4 text-center">
                            <svg className="w-5 h-5 sm:w-6 sm:h-6 inline-block text-[#0f2942]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
