            ...
            {showFilterDropdown && (
              <>
                ...
                <div className="absolute right-0 top-full mt-1 z-20 bg-white border border-[#e2e6ea] rounded py-1 flex flex-col min-w-[100px] sm:min-w-[120px]">
                  ...
                  >
                    <span className={`w-3 h-3 sm:w-3.5 sm:h-3.5 rounded border ${filterOpen ? 'bg-[#1a2332] border-[#1a2332]' : 'border-[#d0d7de]'}`} />
                    Open
                  </button>
                  <button
                    onClick={(e) => {
                    ...
                    className="flex items-center gap-2 text-left px-2.5 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm hover:bg-[#eef1f4] transition text-[#57606a]"
                  >
                    <span className={`w-3 h-3 sm:w-3.5 sm:h-3.5 rounded border ${filterClosed ? 'bg-[#1a2332] border-[#1a2332]' : 'border-[#d0d7de]'}`} />
                    Closed
                  </button>
                </div>
              </>
