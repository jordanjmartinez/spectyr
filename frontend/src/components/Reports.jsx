      ...
      <div className="flex flex-row items-center justify-between gap-2 sm:gap-3">
        ...
        <div className="relative">
          <input
            ...
            maxLength={300}
            className="w-full pl-4 pr-10 py-2 rounded-md bg-[#b1bac4] border border-gray-700 text-gray-900 text-sm placeholder-gray-700 focus:border-gray-500 focus:outline-none transition-colors"
          />
          {!searchTerm && (
