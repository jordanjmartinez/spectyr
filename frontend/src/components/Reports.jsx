        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="relative">
            <button
              ...
              className="inline-flex items-center justify-center gap-1 px-2 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium rounded-md border border-transparent transition bg-[#0f2942] hover:bg-[#16436b] text-white focus:outline-none focus:ring-2 focus:ring-[#8b949e]"
            >
            ...
            {showFilterDropdown && (
              <>
                ...
                <div className="absolute right-0 top-full mt-1 z-20 bg-white border border-[#e2e6ea] rounded py-1 flex flex-col min-w-[100px] sm:min-w-[120px]">
                  ...
                  >
                    <span className={`w-3 h-3 sm:w-3.5 sm:h-3.5 rounded border ${filterOpen ? 'bg-[#0f2942] border-[#0f2942]' : 'border-[#d0d7de]'}`} />
                    Open
                  </button>
                  <button
                    onClick={(e) => {
                    ...
                    className="flex items-center gap-2 text-left px-2.5 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm hover:bg-[#eef1f4] transition text-[#57606a]"
                  >
                    <span className={`w-3 h-3 sm:w-3.5 sm:h-3.5 rounded border ${filterClosed ? 'bg-[#0f2942] border-[#0f2942]' : 'border-[#d0d7de]'}`} />
                    Closed
                  </button>
                </div>
              </>
      ...
      {filteredReports.length === 0 && !searchTerm ? (
        ...
        >
          <div className="flex flex-col items-center justify-center py-8 flex-1">
            ...
            <p className="text-sm text-[#6e7781]">Write a report from Alerts to document your findings.</p>
          </div>
        </div>
      ) : filteredReports.length === 0 && searchTerm ? (
          ...
          <div className="relative bg-white border border-[#e2e6ea] rounded-xl p-6 w-full max-w-md mx-4 shadow-2xl animate-modalIn">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                ...
                className="inline-flex items-center justify-center px-2 sm:px-3 py-1.5 sm:py-2 text-xs font-medium rounded-md border transition bg-[#1a2332] hover:bg-[#0f2942] text-white border-transparent focus:outline-none focus:ring-2 focus:ring-[#8b949e]"
              >
                Delete
              </button>
            </div>
